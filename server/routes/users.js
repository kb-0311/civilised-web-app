...
const { registerUser, loginUser, logout, getAllUsers, followUser, updatePassword, updateProfile, getMyProfile, deleteMyProfile, getMyPosts, getUserPosts } = require('../controllers/user');
